...
namespace Haitech\DevTool\Commands;

use Haitech\DevTool\Commands\Abstracts\BaseMakeCommand;
use File;
...
class PackageCreateCommand extends BaseMakeCommand
{
    ...
    public function handle()
    {
        ...
        $this->line('<info>Add</info> <comment>"haitech/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!');
        $this->line('------------------');
